    ...
    return(
        <>
            ...
            <div className='ScrollIndicator'>
                <svg className='ScrollIndicator__arrow' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 10L12 15L17 10" stroke="#d77bba" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <p className='ScrollIndicator__text'>Role para ver mais</p>
            </div>

            <div className='Biografia'>
                <img src={MinhaFoto} alt="Lyandra Almeida da Silva" className='Biografia__foto'/>
                <div className='Biografia__info'>
